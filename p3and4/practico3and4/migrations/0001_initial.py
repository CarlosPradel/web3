    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generos', models.ManyToManyField(to='practico3and4.genero')),
            ],
        ),
        migrations.CreateModel(
            name='DetalleCompra',
            fields=[
                ...
                ('compra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detalles', to='practico3and4.compra')),
                ('libro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='practico3and4.libro')),
            ],
        ),
        migrations.CreateModel(
            name='CarritoItem',
